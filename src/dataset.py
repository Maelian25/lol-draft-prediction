    ...
    def __init__(
        ...
        match region.upper():
            case "EUROPE":
                ...
                self.match_host = "europe.api.riotgames.com"
            case "AMERICA":
                self.host = "na1.api.riotgames.com"
                self.match_host = "americas.api.riotgames.com"
            case "KOREA":
                self.host = "kr.api.riotgames.com"
                self.match_host = "asia.api.riotgames.com"
            case _:
                self.host = "euw1.api.riotgames.com"
                self.match_host = "europe.api.riotgames.com"
                ...
                game_data.append(
                    {
                        ...
                        "game_duration": round(
                            game_info.get("gameDuration", 0) / 60, 2
                        ),
                        "game_creation": convert_unix_timestamp_to_date(
                            game_info.get("gameCreation", 0) / 1000
                        ),
